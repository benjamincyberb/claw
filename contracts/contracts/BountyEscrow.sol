 ...
 * @dev Task bounty system where $XDOG tokens are locked in escrow.
...
contract BountyEscrow is Ownable, ReentrancyGuard {
    ...
    IERC20 public immutable XDOGCoin;
    ...
    constructor(address _XDOGCoin) Ownable(msg.sender) {
        XDOGCoin = IERC20(_XDOGCoin);
    }

    /**
     * @notice Create a new bounty and lock $XDOG tokens in escrow.
     *         "Put your money where your mouth is, boss."
     * @param description Task description (e.g., "Fix the prod bug at 3 AM")
     * @param amount Amount of $XDOG to lock as reward
     */
    function createBounty(string calldata description, uint256 amount) external nonReentrant {
        ...
        XDOGCoin.safeTransferFrom(msg.sender, address(this), amount);
    ...
    function completeBounty(uint256 bountyId) external nonReentrant {
        ...
        XDOGCoin.safeTransfer(b.worker, b.amount);
    ...
    function cancelBounty(uint256 bountyId) external nonReentrant {
        ...
        XDOGCoin.safeTransfer(b.creator, b.amount);
